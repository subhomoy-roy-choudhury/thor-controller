            ...
            <div className='flex flex-wrap mx-4 justify-left'>
                {Object.entries(data).map(([key, value]) => (
                    <div key={key} className="py-6 pl-6 pr-20 mt-10 mr-10 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <a href="#" className="inline-flex items-center py-2 px-3 mt-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Delete
